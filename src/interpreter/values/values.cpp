...
namespace interpreter {
    ...
    RuntimeResult::RuntimeResult(const std::shared_ptr<RuntimeValue> result, const std::shared_ptr<errors::Error> error, const bool breaking, const bool continuing) {
        this->result = result;
        this->error = error;
